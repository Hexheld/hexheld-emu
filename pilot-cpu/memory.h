...
Pilot_memctl_state Pilot_mem_addr_read_assert (Pilot_system *sys, uint_fast24_t addr);
Pilot_memctl_state Pilot_mem_addr_write_assert (Pilot_system *sys, uint_fast24_t addr, uint16_t data);
